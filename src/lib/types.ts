...
export type View = 'dashboard' | 'journal' | 'journal-new' | 'journal-edit' | 'thoughtRecord' | 'thoughtRecord-new' | 'thoughtRecord-edit' | 'planner' | 'medication' | 'affirmations' | 'soothingSounds' | 'profile' | 'resources' | 'designSystem' | 'understanding-cbt' | 'mindfulness-techniques' | 'crisis-support';
...
export interface CalendarEvent {
  ...
  allDay: boolean;
  description?: string;
  color: string; // Tailwind background color class, e.g., 'bg-primary', 'bg-secondary-500'
}
